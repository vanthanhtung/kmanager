...
- Name: venue-admin.spec.ts >> Venue Admin >> create venue form shows hotline and wifi fields
- Location: tests/e2e/venue-admin.spec.ts:13:3
...
Call log:
  ...
  - waiting for getByLabel('Hotline')
...
- main:
  - button "← Quay lại"
  - heading "Tạo địa điểm mới" [level=1]
  - text: Tên địa điểm *
  - textbox
  - text: Địa chỉ
  - textbox
